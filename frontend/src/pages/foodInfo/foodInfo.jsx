...
const FoodInfo = () => {
    ...
    */
     ...
     */
    const isFirstRenderRatings2 = useRef(true); // don't do anything on first render
    useEffect(() => {
        if (isFirstRenderRatings2.current) {
            isFirstRenderRatings2.current = false;
            return;
        }
     ...
     */
    const isFirstRenderSaved = useRef(true); // don't do anything on first render
    useEffect(() => {
        if (isFirstRenderSaved.current) {
            isFirstRenderSaved.current = false;
            return;
        }
